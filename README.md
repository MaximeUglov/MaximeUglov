...
Закончил курсы по Python, математике и статистике на платформе Stepik. После этого прошёл курс по машинному обучению в karpov.courses, где разработал рекомендательную систему.   
